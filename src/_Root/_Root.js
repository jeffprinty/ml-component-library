...
const componentExample = require("raw!../MLButton/MLButton.example");
  ...
  render() {
    return (
      <div className={ css['container']}>
        ...
        <Demo>
          <h2>Button</h2>
          <Playground codeText={require('raw!../MLButton/MLButton.example')} scope={{React, ReactDOM, MLButton, Colors, MLIcon}}/>
        </Demo>

        <Demo>
          <h2>Menu</h2>
          <Playground codeText={require('raw!../MLMenu/MLMenu.example')} scope={{React, ReactDOM, MLMenu}}/>
        </Demo>

        <Demo>
          <h2>Accordion</h2>
          <Playground codeText={require('raw!../MLAccordion/MLAccordion.example')} scope={{React, ReactDOM, MLAccordion}}/>
        </Demo>

        <Demo>
          <h2>Card</h2>
          <Playground codeText={require('raw!../MLCard/MLCard.example')} scope={{React, ReactDOM, MLCard, MLButton}}/>
        </Demo>

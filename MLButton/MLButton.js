...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Button, 'Button', 'src/MLButton/MLButton.js');

  __REACT_HOT_LOADER__.register(Title, 'Title', 'src/MLButton/MLButton.js');

  __REACT_HOT_LOADER__.register(Icon, 'Icon', 'src/MLButton/MLButton.js');

  __REACT_HOT_LOADER__.register(MLButton, 'MLButton', 'src/MLButton/MLButton.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/MLButton/MLButton.js');
}();

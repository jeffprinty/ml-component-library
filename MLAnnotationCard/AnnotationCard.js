...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(deleteTimeout, 'deleteTimeout', 'src/MLAnnotationCard/AnnotationCard.js');

  __REACT_HOT_LOADER__.register(AnnotationCard, 'AnnotationCard', 'src/MLAnnotationCard/AnnotationCard.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/MLAnnotationCard/AnnotationCard.js');
}();

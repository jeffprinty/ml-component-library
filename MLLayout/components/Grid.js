...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(propTypes, 'propTypes', 'src/MLLayout/components/Grid.js');

  __REACT_HOT_LOADER__.register(Grid, 'Grid', 'src/MLLayout/components/Grid.js');
}();

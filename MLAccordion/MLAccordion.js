...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Accordion, 'Accordion', 'src/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(AccordionTitle, 'AccordionTitle', 'src/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(AccordionIcon, 'AccordionIcon', 'src/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(TitleText, 'TitleText', 'src/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(AccordionContent, 'AccordionContent', 'src/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(MLAccordion, 'MLAccordion', 'src/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/MLAccordion/MLAccordion.js');
}();

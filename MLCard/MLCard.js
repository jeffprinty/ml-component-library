...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(Card, 'Card', 'src/MLCard/MLCard.js');

  __REACT_HOT_LOADER__.register(CardTitle, 'CardTitle', 'src/MLCard/MLCard.js');

  __REACT_HOT_LOADER__.register(TitleText, 'TitleText', 'src/MLCard/MLCard.js');

  __REACT_HOT_LOADER__.register(HeaderButton, 'HeaderButton', 'src/MLCard/MLCard.js');

  __REACT_HOT_LOADER__.register(CardContent, 'CardContent', 'src/MLCard/MLCard.js');

  __REACT_HOT_LOADER__.register(MLCard, 'MLCard', 'src/MLCard/MLCard.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/MLCard/MLCard.js');
}();

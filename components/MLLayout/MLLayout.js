...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Layout, 'Layout', 'src/components/MLLayout/MLLayout.js');

  __REACT_HOT_LOADER__.register(Title, 'Title', 'src/components/MLLayout/MLLayout.js');

  __REACT_HOT_LOADER__.register(Icon, 'Icon', 'src/components/MLLayout/MLLayout.js');

  __REACT_HOT_LOADER__.register(MLLayout, 'MLLayout', 'src/components/MLLayout/MLLayout.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/MLLayout/MLLayout.js');
}();

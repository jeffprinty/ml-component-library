...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ModificatorType, 'ModificatorType', 'src/components/MLLayout/components/Col.js');

  __REACT_HOT_LOADER__.register(propTypes, 'propTypes', 'src/components/MLLayout/components/Col.js');

  __REACT_HOT_LOADER__.register(classMap, 'classMap', 'src/components/MLLayout/components/Col.js');

  __REACT_HOT_LOADER__.register(getClassNames, 'getClassNames', 'src/components/MLLayout/components/Col.js');

  __REACT_HOT_LOADER__.register(Col, 'Col', 'src/components/MLLayout/components/Col.js');
}();

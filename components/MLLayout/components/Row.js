...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(ModificatorType, 'ModificatorType', 'src/components/MLLayout/components/Row.js');

  __REACT_HOT_LOADER__.register(modificatorKeys, 'modificatorKeys', 'src/components/MLLayout/components/Row.js');

  __REACT_HOT_LOADER__.register(propTypes, 'propTypes', 'src/components/MLLayout/components/Row.js');

  __REACT_HOT_LOADER__.register(getClassNames, 'getClassNames', 'src/components/MLLayout/components/Row.js');

  __REACT_HOT_LOADER__.register(Row, 'Row', 'src/components/MLLayout/components/Row.js');
}();

...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Dropdown, 'Dropdown', 'src/components/MLMenu/MLMenu.js');

  __REACT_HOT_LOADER__.register(DropdownTitle, 'DropdownTitle', 'src/components/MLMenu/MLMenu.js');

  __REACT_HOT_LOADER__.register(Chevron, 'Chevron', 'src/components/MLMenu/MLMenu.js');

  __REACT_HOT_LOADER__.register(DropdownClosed, 'DropdownClosed', 'src/components/MLMenu/MLMenu.js');

  __REACT_HOT_LOADER__.register(DropdownOpen, 'DropdownOpen', 'src/components/MLMenu/MLMenu.js');

  __REACT_HOT_LOADER__.register(DropdownItem, 'DropdownItem', 'src/components/MLMenu/MLMenu.js');

  __REACT_HOT_LOADER__.register(MLMenu, 'MLMenu', 'src/components/MLMenu/MLMenu.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/MLMenu/MLMenu.js');
}();

...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Demo, 'Demo', 'src/components/_Root/_Root.js');

  __REACT_HOT_LOADER__.register(Mi, 'Mi', 'src/components/_Root/_Root.js');

  __REACT_HOT_LOADER__.register(NavLink, 'NavLink', 'src/components/_Root/_Root.js');

  __REACT_HOT_LOADER__.register(_Root, '_Root', 'src/components/_Root/_Root.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/_Root/_Root.js');
}();

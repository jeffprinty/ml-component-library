...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Accordion, 'Accordion', 'src/components/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(AccordionTitle, 'AccordionTitle', 'src/components/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(AccordionIcon, 'AccordionIcon', 'src/components/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(TitleText, 'TitleText', 'src/components/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(AccordionContent, 'AccordionContent', 'src/components/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(MLAccordion, 'MLAccordion', 'src/components/MLAccordion/MLAccordion.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/components/MLAccordion/MLAccordion.js');
}();

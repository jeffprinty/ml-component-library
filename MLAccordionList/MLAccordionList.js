...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Accordion, 'Accordion', 'src/MLAccordionList/MLAccordionList.js');

  __REACT_HOT_LOADER__.register(AccordionTitle, 'AccordionTitle', 'src/MLAccordionList/MLAccordionList.js');

  __REACT_HOT_LOADER__.register(AccordionIcon, 'AccordionIcon', 'src/MLAccordionList/MLAccordionList.js');

  __REACT_HOT_LOADER__.register(TitleText, 'TitleText', 'src/MLAccordionList/MLAccordionList.js');

  __REACT_HOT_LOADER__.register(AccordionContent, 'AccordionContent', 'src/MLAccordionList/MLAccordionList.js');

  __REACT_HOT_LOADER__.register(MLAccordion, 'MLAccordion', 'src/MLAccordionList/MLAccordionList.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/MLAccordionList/MLAccordionList.js');
}();
